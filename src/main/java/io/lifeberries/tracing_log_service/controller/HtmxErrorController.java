...
/**
 * Extends default Spring Boot error handling with a custom error method for htmx requests. Always
 * returns http status 200 so the HTML is swapped properly in the client.
 *
